        ...
        $(document).ready(function(){
            ...
            if ( this.value == "{{ $surat->jenis_surat_id }}"){
                ...
                //.....................^.......
                {
                    ...
                    "<h3><b id='head-form'>FORM SURAT KEPUTUSAN</b></h3><div class='form-group'><label for='item1'>Nama pihak pertama</label><input class='form-control' id='item1' autocomplete='off' name='item1' type='text' value=''></div>       <div class='form-group'>    <label for='item2'>Jabatan pihak pertama</label>    <input class='form-control' id='item2' autocomplete='off' name='item2' type='text' value=''></div><div class='form-group'> <label for='item3'>NIK pihak pertama</label><input class='form-control' id='item3' autocomplete='off' name='item3' type='text' value=''></div><div class='form-group'><label for='item4'>Alamat pihak pertama</label><input class='form-control' id='item4' autocomplete='off' name='item4' type='text' value=''></div><div class='form-group'><label for='item5'>No. HP pihak pertama</label> <input class='form-control' id='item5' autocomplete='off' name='item5' type='text' value=''></div><div class='form-group'> <label for='item6'>Bertindak untuk Atas Nama</label> <input class='form-control' id='item6' autocomplete='off' name='item6' type='text' value=''></div><div class='form-group'><label for='item7'>Badan hukum</label><input class='form-control' id='item7' autocomplete='off' name='item7' type='text' value=''></div><div class='form-group'><label for='item8'>Alamat untuk Atas Nama</label> <input class='form-control' id='item8' autocomplete='off' name='item8' type='text' value=''></div><div class='form-group'><label for='item9'>Nama pihak kedua</label><input class='form-control' id='item9' autocomplete='off' name='item9' type='text' value=''></div>  <div class='form-group'> <label for='item10'>Jabatan pihak kedua</label>    <input class='form-control' id='item10' autocomplete='off' name='item10' type='text' value=''></div>       <div class='form-group'>    <label for='item11'>NIK pihak kedua</label>    <input class='form-control' id='item11' autocomplete='off' name='item11' type='text' value=''></div>       <div class='form-group'>    <label for='item12'>Alamat pihak kedua</label>    <input class='form-control' id='item12' autocomplete='off' name='item12' type='text' value=''></div>                  <div class='form-group'>    <label for='item13'>No. HP pihak kedua</label>    <input class='form-control' id='item13' autocomplete='off' name='item13' type='text' value=''></div>                            <div class='form-group'>    <label for='item14'>Tujuan</label>    <input class='form-control' id='item14' autocomplete='off' name='item14' type='text' value=''></div>                            <div class='form-group'>    <input class='form-control' id='item15' style='visibility: hidden' autocomplete='off' name='item15' type='text' value=''></div> <div class='form-group'>    <input class='form-control' id='item16' style='display:none;' autocomplete='off' name='item16' type='text' value=''></div>                            <div class='form-group'>    <input class='form-control' id='item17' style='display:none;' autocomplete='off' name='item17' type='text' value=''></div>                            <div class='form-group'>    <input class='form-control' id='item18' style='display:none;' autocomplete='off' name='item18' type='text' value=''></div>                            <div class='form-group'>    <input class='form-control' id='item19' style='display:none;' autocomplete='off' name='item19' type='text' value=''></div>                            <div class='form-group'>    <input class='form-control' id='item20' style='display:none;' autocomplete='off' name='item20' type='text' value=''></div>";
