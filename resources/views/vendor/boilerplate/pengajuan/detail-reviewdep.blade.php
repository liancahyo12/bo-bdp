...
@section('content')
    <x-boilerplate::form :route="['boilerplate.update-reviewdep-pengajuan', $pengajuan->ida]" method="put" files>
    @csrf
    <x-boilerplate::card>
            <x-slot name="header">
                <b>Komentar</b>
            ...
            <div @if ($pengajuan->reviewdep_status==2 || $pengajuan->reviewdep_status==3 || $pengajuan->reviewdep_status==4)
                style='display:none;'
                @endif>
            ...
            <div>
                <input class="btn btn-warning" name="submitbutton" type="submit" value="Revisi" @if ($pengajuan->reviewdep_status==2 || $pengajuan->reviewdep_status==3 || $pengajuan->reviewdep_status==4)
                style='display:none;'
                @endif>
                &nbsp;
                <input class="btn btn-danger" name="submitbutton" type="submit" value="Tolak" @if ($pengajuan->reviewdep_status==2 || $pengajuan->reviewdep_status==3 || $pengajuan->reviewdep_status==4)
                style='display:none;'
                @endif>
                &nbsp;
                <input class="btn btn-primary" name="submitbutton" type="submit" value="Setujui" @if ($pengajuan->reviewdep_status==2 || $pengajuan->reviewdep_status==3 || $pengajuan->reviewdep_status==4)
                style='display:none;'
                @endif>
            </div>
