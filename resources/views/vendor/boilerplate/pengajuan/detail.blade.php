...
@section('content')
    ...
    <script>        
        $(document).ready(function(){
            ...
            var jatuhtempo2 = "{{ substr($pengajuan->jatuhtempo, 4,4) }}";
            var jatuhtempo1 = "{{ $pengajuan->jatuhtempo }}";
            var jatuhtempo3 = "{{ substr($pengajuan->jatuhtempo, 0,4) }}";
            var jatuhtempo4 = "{{ substr($pengajuan->jatuhtempo, 11,8) }}";
