    ...
    @csrf
        ...
        <x-boilerplate::card>
            ...
            <div id="postpaid" style='display:none;'>
                <x-boilerplate::input name="noinvoice" id="noinvoice" type="text" label="Nomor Invoice" value="{{ $pengajuan->no_invoice }}" disabled/>
                <x-boilerplate::datetimepicker name="jatuhtempo" id="jatuhtempo" format="DD/MM/YYYY HH:mm" label='Tanggal Jatuh Tempo' value="{{ $pengajuan->jatuhtempo }}" disabled/>
            </div>
        ...
        <x-boilerplate::card>
            ...
            @foreach ( $approvepengajuan as $approvepengajuan)
                <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img src="{{ App\Models\Boilerplate\User::where('id', $approvepengajuan->uid)->first()->avatar_url }}" class="direct-chat-img" alt="{{ $approvepengajuan->first_name }}" width="30" height="30">
                    <!-- /.direct-chat-img -->
