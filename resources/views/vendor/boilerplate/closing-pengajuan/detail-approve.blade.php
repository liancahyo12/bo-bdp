@extends('boilerplate::layout.index', [
    ...
    'subtitle' => __('Approve Closing Pengajuan'),
    'breadcrumb' => [
...
<x-boilerplate::form :route="['boilerplate.update-approve-closing-pengajuan', $closing->ida]" method="put" files>
    @csrf
    <x-boilerplate::card>
        <x-slot name="header">
            <b>Komentar</b>
        ...
        @endforeach
        <div @if ($closing->approve_status==2 || $closing->approve_status==3 || $closing->approve_status==4)
            style='display:none;'
            @endif>
