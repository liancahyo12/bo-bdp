        ...
        $(document).ready(function(){
            ...
            if ( "{{ $pengajuan->jenis_pengajuan_id }}" == 3){
                ...
                $('#tambah').click(function(){
                    no++;
                    $('#dynamic').append("<tr id='row"+no+"'><td><input class='form-control' type='text' name='transaksia[]' id='transaksia"+no+"'></td><td><input class='form-control angka' type='number' name='nominala[]' id='nominal"+no+"'></td><td><button type='button' id='"+no+"' class='btn btn-danger btn_remove'>Hapus</button></td></tr>");
                });
