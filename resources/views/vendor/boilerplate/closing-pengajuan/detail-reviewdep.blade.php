...
<x-boilerplate::form :route="['boilerplate.update-reviewdep-closing-pengajuan', $closing->ida]" method="put" files>
    @csrf
    <x-boilerplate::card>
        <x-slot name="header">
            <b>Komentar</b>
        ...
        @endforeach
        <div @if ($closing->reviewdep_status==2 || $closing->reviewdep_status==3 || $closing->reviewdep_status==4)
            style='display:none;'
            @endif>
