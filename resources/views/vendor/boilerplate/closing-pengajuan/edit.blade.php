    ...
    <div class="col-md-6">
        ...
        @csrf
            <x-boilerplate::card>
                ...
                <x-boilerplate::datetimepicker name="tgl_closing" label='Tanggal Closing*' value="{{ $closing->tgl_closing}}" required/>
                <div id="form-closing">
                </div>
                <x-boilerplate::input name="catatana" type="text" label="Catatan*" value="{{$closing->catatan}}" required/>
