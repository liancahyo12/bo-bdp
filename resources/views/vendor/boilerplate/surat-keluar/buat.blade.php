...
@section('content')
    <x-boilerplate::form :route="['boilerplate.surat-keluar-buat']" method="post" files>
        ...
        <x-boilerplate::card>
            ...
            <x-boilerplate::input name="perihal" label="Perihal*" required/>
            <div class="form-group">
                <div class="input-group" id="unduh-format">
                </div>
                <div id="ket"></div>
            </div>
            <x-boilerplate::input name="file_surat" type="file" label="Unggah Surat Keluar* (Word DOCX Maks 20MB)" required/>
