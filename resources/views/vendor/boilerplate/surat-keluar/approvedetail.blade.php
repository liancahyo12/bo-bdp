...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col" @if ($surat->approve_status==2 || $surat->approve_status==3 || $surat->approve_status==4)
        style='display:none;'
        @endif >
            <x-boilerplate::card>
    ...
    <div class="row" @if ($surat->approve_status==2 || $surat->approve_status==3 || $surat->approve_status==4)
        style='display:none;'
        @endif>
        &nbsp; &nbsp;
        {{ Form::submit('Preview Surat', array('class' => 'btn btn-secondary', 'name' => 'submitbutton')) }}
