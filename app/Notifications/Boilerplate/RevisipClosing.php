...
class RevisipClosing extends Notification
{
    use Queueable;
    public $id;
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('Bukti pengembalian '.$isi->jenis_pengajuan.' '.$isi->transaksi.$isi->jenis_transaksi.' perlu direvisi', [
            ]))
            ->action(
                __('Revisi Bukti Pengembalian'),
