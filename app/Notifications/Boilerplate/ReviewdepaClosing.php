...
class ReviewdepaClosing extends Notification
{
    use Queueable;
    public $id;
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('Closing '.$isi->jenis_pengajuan.' '.$isi->transaksi.$isi->jenis_transaksi.'...... oleh '.$isi->first_name.' perlu direview', [
            ]))
            ->action(
                __('Review Closing Pengajuan'),
                route('boilerplate.detail-reviewdep-closing-pengajuan', $this->id)
            )
