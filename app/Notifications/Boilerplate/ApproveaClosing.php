...
class ApproveaClosing extends Notification
{
    use Queueable;
    public $id;
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('Closing pengajuan '.$isi->jenis_pengajuan.' '.$isi->transaksi.$isi->jenis_transaksi.'...... oleh '.$isi->first_name.' butuh Approval', [
            ]))
            ->action(
                __('Approve Closing Pengajuan'),
                route('boilerplate.detail-approve-closing-pengajuan', $this->id)
            )
            ->line(__('Silahkan tekan tombol di atas untuk approve closing pengajuan'));
    }
