...
class BayaredPengajuan extends Notification
{
    use Queueable;
    public $id;
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('Pengajuan '.$isi->jenis_pengajuan.' '.$isi->transaksi.$isi->jenis_transaksi.'...... telah dibayar', [
            ]))
            ->action(
                __('Lihat Detail'),
                route('boilerplate.edit-pengajuan', $this->id)
            )
            ->line(__('Silahkan tekan tombol di atas untuk lihat detail pengajuan'));
    }
