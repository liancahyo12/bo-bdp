...
class ApprovedClosing extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('Closing pengajuan '.$isi->jenis_pengajuan.' '.$isi->transaksi.$isi->jenis_transaksi.' telah diapprove, silahkan lanjutkan pengembalian dana karena realisasi pengunaan dana kurang dari pengajuan Anda', [
            ]))
            ->action(
