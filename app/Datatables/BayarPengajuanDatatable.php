...
class BayarPengajuanDatatable extends Datatable
{
    ...
    {
        return pengajuan::leftJoin('jenis_pengajuans', 'pengajuans.jenis_pengajuan_id', 'jenis_pengajuans.id')->whereRaw('pengajuans.status = 1 and review_status=2 and reviewdep_status=2 and approve_status=2 and (jenis_pengajuan_id=2 or jenis_pengajuan_id=3 or jenis_pengajuan_id=4 or jenis_pengajuan_id=6)')->orderByDesc('pengajuans.updated_at')->get(['pengajuans.id',
        'pengajuan',
        'tgl_pengajuan',
        'jenis_pengajuan',
        'no_pengajuan',
